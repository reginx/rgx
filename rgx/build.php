...
class app_build extends build {
    ...
    public function run () {
        $app_config = [
            ...
            'prefix'    => $this->get_input("please enter the application installation invalid application installation path",
                $this->get_param('prefix')),
        ];
        ...
        // create dir
        foreach (['config', 'module', 'lang', 'plugin', 'template/default'] as $item) {
    ...
    public function create_entry ($app = []) {
        $rel_rgx_path = $this->get_relpath($app['prefix'], $this->dir);
...
class table_build extends build {
    ...
    public function run () {
        ...
        $app_config = [
            'prefix'        => $this->get_input("please enter the application installation path",
                $this->get_param('prefix')),
